  ...
  return (
    <div>
      <div className="relative flex items-end justify-end mr-[20%] mt-[5%] font-semibold cursor-pointer">
        ...
        {open && (
          <div className="absolute top-[21px] right-0 h-[200px] w-[250px] bg-[#d9d9d9] z-[999] shadow-xl">
      ...
      <div className="flex flex-col mr-[10%] ml-[10%]">
        ...
        {parcels.map((parcel, index) => (
          ...
          <div
            className="flex justify-between bg-[#d9d9d9] h-[150px] w-[70vw] m-[20px] p-[20px] cursor-pointer text-[#555] "
            >
